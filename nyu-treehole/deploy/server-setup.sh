...
echo "  sleep 30 && docker compose exec -T app npx prisma@6.19.2 migrate deploy"
echo "  docker compose exec -T app npx prisma@6.19.2 db seed"
echo "=========================================="
